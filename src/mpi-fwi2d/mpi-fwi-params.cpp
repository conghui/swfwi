...
MpiFwiParams *MpiFwiParams::ins = NULL;

MpiFwiParams::MpiFwiParams() {
  int rank;
...
MpiFwiParams& MpiFwiParams::instance() {
  if (ins == NULL) {
    ins = new MpiFwiParams();
    ins->getInputParams();
    ins->check();
    ins->putOutputParams();
    ins->calVars();
...
void MpiFwiParams::getInputParams() {
